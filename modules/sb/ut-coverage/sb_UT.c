...
#define SB_UT_EDS_DISPATCH(intf,cmd) \
    ...
    .TableOffset = offsetof(CFE_SB_Application_Component_Telecommand_DispatchTable_t, intf.cmd)

#define SB_UT_MSG_DISPATCH(intf,cmd)      SB_UT_EDS_DISPATCH(intf, indication), UT_TPD_SETSIZE(CFE_SB_ ## cmd)
#define SB_UT_CC_DISPATCH(intf,cc,cmd)    SB_UT_EDS_DISPATCH(intf, cmd ## _indication), UT_TPD_SETSIZE(CFE_SB_ ## cmd), UT_TPD_SETCC(cc)
...
{
    CFE_SB_SoftwareBus_PubSub_Interface_t * Output = UT_Hook_GetArgValueByName(Context, "Output", CFE_SB_SoftwareBus_PubSub_Interface_t *);
    const CFE_SB_Publisher_Component_t *Input = UT_Hook_GetArgValueByName(Context, "Input", const CFE_SB_Publisher_Component_t *);
    int32 StatusCode;
...
{
    CFE_SB_SoftwareBus_PubSub_Interface_t * Output = UT_Hook_GetArgValueByName(Context, "Output", CFE_SB_SoftwareBus_PubSub_Interface_t *);
    const CFE_SB_Listener_Component_t *Input = UT_Hook_GetArgValueByName(Context, "Input", const CFE_SB_Listener_Component_t *);
    int32 StatusCode;

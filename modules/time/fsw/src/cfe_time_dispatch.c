...
void CFE_TIME_TaskPipe(CFE_SB_Buffer_t *SBBufPtr)
{
    ...
    CmdStatus = CFE_TIME_Application_Component_Telecommand_Dispatch(CFE_SB_Telecommand_indication_Command_ID, SBBufPtr,
    ...
    if (CmdStatus != CFE_SUCCESS)
    {
        ...
        if (CmdStatus == CFE_STATUS_BAD_COMMAND_CODE)
        {

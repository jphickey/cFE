...
function(prepare)
  ...
  file(WRITE "${MISSION_BINARY_DIR}/tables/Makefile"
    "CFE_MAKEFILE_SOURCE := ${CFE_SOURCE_DIR}/cmake/tables/mission_tables.mk\n"
    "MISSION_DEFS := ${MISSION_DEFS}\n"
    "include \$(CFE_MAKEFILE_SOURCE) \$(wildcard *.d)\n"
  )
  ...
  foreach(CPUNAME ${MISSION_CPUNAMES})
    install(DIRECTORY ${CMAKE_BINARY_DIR}/tables/${CPUNAME}/ DESTINATION ${CPUNAME})
  endforeach()
